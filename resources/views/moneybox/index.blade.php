...
@section('container')
    <div class="row mt-5">
        <div class="col-lg-6">
            @foreach ($moneyboxes as $moneybox)
                <div id="moneyboxChart{{ $moneybox->id }}" style="width: 100%; height: 300px;"></div>
            @endforeach
        </div>
                ...
                @foreach ($moneyboxes as $moneybox)
                    <div class="white-bar">
                        ...
                        <div class="progress mb-3" role="progressbar" aria-label="Basic example"
                             ...
                             aria-valuemax="{{ $moneybox->target_moneybox }}">
                            <div class="progress-bar"
                                 style="width: {{ ($moneybox->nominal_moneybox / $moneybox->target_moneybox) * 100 }}%"></div>
                        </div>
